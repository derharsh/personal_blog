...
\begin{itemize}
  ...
  \item \textbf{Analysis II} - \textit{Topology and Differential Calculus of Several Variables}
  \item Analysis III - \textit{Measure Theory, Manifolds, and Integral Calculus of Several Variables}
