...
These notes were prepared between October 2025 and (tentative) \textbf{(Last update: \today)}.
...
The first volume covers the basic concepts typically presented in a one-semester course of vector spaces, linear maps, matrix theory and eigen theory. We will also consider many applications, though primarily to the fields of theoretical physics and computer science. Applications to differential equations or other areas of maths are not considered here.
