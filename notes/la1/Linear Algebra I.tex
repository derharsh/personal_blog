...
These notes were prepared between October 2025 and March 2026 \textbf{(Last update: \today)}.
...
\begin{itemize}
  ...
  \item \textbf{Linear Algebra I} - \textit{Algebraic Foundations, Vector Spaces, Matrix and Eigenvalue Theory}
