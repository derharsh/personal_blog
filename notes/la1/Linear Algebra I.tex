...
The \textbf{prerequisites} for this course are working knowledge of \textbf{logic, sets} and \textbf{proof techniques}, you can refer to my notes on \emph{Mathematical Preliminaries} for those topics. Those notes cover much more than we need for this course but you can skip some sections and cover the essentials. Apart from that, only high school mathematics is expected from the readers.
\clearpage
