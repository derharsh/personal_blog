...
These notes were prepared between January 2026 and March 2026 \textbf{(Last update: \today)}.
...
Some of you might be thinking, \textit{\enquote{Isn't this just how maths is supposed to be? You need to show that something is true, so why even ask such questions?}}
...
But if you try the same argument in a university-level maths course, you'll likely be told to switch majors to some natural science.
...
These questions aren't silly at all. In fact, they're the very same ones that puzzled mathematicians like Hilbert, Russell, Cantor, and Gödel during the late 19th and early 20th centuries, a period often called the \emph{"crisis of rigour"} in mathematics. And these questions should puzzle you too.
...
To actually answer these questions in detail, you'd need several graduate-level courses, in logic, proof theory, set theory, model theory, metamathematics, and even philosophy, and probably a small library's worth of books, just to discover that the answers are \emph{still} missing.
