...
\usepackage{csquotes, lmodern, makeidx}
\usepackage{tikz-cd}
...
\noindent These notes closely follow these two lecture notes' preliminary sections (section 1 in both notes). However, they are written in German.
...
\begin{itemize}
    ...
    \item Daniel J. Velleman, How to Prove It: A Structured Approach, Cambridge University Press, 2006.
    \item Richard Hammack, Book of Proof, 2013.
\end{itemize}
\clearpage
...
Sets are the foundation of modern mathematics. Most mathematical entitics can be studied as sets or classes of objects. We could have introduced some concepts of sets before chapter 1, But doing so in this order has a logical advantage.\footnote{Tehcnically, we have used sets in some examples of previous chapters for which intuitiv set theory is more than enough.}
